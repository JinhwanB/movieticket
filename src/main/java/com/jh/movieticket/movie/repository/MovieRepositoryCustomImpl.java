...
public class MovieRepositoryCustomImpl implements MovieRepositoryCustom {
    ...
    @Override
    public Page<Movie> findBySearchOption(String title, ScreenType screenType, String genre,
        ...
        List<Movie> movies = jpaQueryFactory.selectFrom(movie)
            ...
            .where(containsTitle(title), eqScreenType(screenType), eqGenre(genre), movie.deleteDate.isNull())
